...
<body>
    ...
    <div style="display:flex;flex-wrap:wrap;justify-content:center;align-items:center;gap:2rem">
      <div style="flex:1 1 45%;min-width:300px">
        <div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;border-radius:12px">
          <iframe src="https://www.youtube.com/embed/cM7UL9snXL8?si=g-hUkPwKKBkct9tt"
  ...
  <section class="intro">
    <div style="display:flex;flex-wrap:wrap;justify-content:center;align-items:center;gap:2rem">
      <h3>O crescimento das cidades está reduzindo as áreas verdes</h3>

      <div style="flex:1 1 45%;min-width:300px;text-align:justify">
        <p>Já percebeu que os lugares com muito concreto, prédios e asfalto são mais quentes? Isso acontece porque o
    ...
    <div style="display:flex;flex-wrap:wrap;gap:2rem;justify-content:center;margin-top:2rem">
      <div style="flex:1 1 300px;min-width:250px">
        ...
        <div style="text-align:justify">
          ...
          <p><strong>🌱 A matemática e a natureza podem andar juntas!</strong> Façam suas descobertas e compartilhem com a turma!</p>
        </div>
      </div>
  ...
  <section class="math-tips bg-white p-6 rounded-xl shadow-md">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm md:text-base">
      ...
      <div class="rounded-lg p-4 bg-gray-50 shadow-sm">
        ...
        <p>Pesquise informações sobre quais árvores são adequadas para arborização. Será que é possível plantar qualquer árvore?</p>
      </div>
  ...
  <section class="intro" style="margin-top:3rem;text-align:center">
    ...
    <p style="font-size:1.2rem">Descubra no mapa onde podemos plantar árvores na escola! 🌳<br>Depois, volte aqui e faça o cálculo!</p>
    ...
    <p>Digite o tamanho do espaço que vocês mediram e escolha o espaço para cada árvore</p>

    <button onclick="toggleCalculadora()"
      style="background:#ffd54f;border:none;padding:10px 16px;border-radius:12px;font-size:1.4rem;cursor:pointer">
      💡 Mostrar calculadora
    </button>

    <div id="calculadoraArvores" style="display:none;margin:2rem auto;max-width:400px;padding:1rem;background:#f0fff0;border-radius:12px">
    ...
    <h2>💡 Sua Resposta!</h2>
    <p style="font-size:1.1rem">Agora escreva o que você descobriu! 😊</p>
  ...
  <script>
    ...
    function baixarPDF() {
      ...
      if (!resposta) {
        confirmacao.innerText = "✗ Escreva sua resposta primeiro!";
        return;
      }
      ...
      pdf.setFontSize(18);
      pdf.text("Relatório de Arborização", 20, y); y += 15;
      pdf.setFontSize(12);
      pdf.text("Data: " + data, 20, y); y += 20;
      pdf.setFontSize(14);
      pdf.text("Resposta do aluno:", 20, y); y += 10;
      pdf.text(pdf.splitTextToSize(resposta, 170), 20, y);
      pdf.save("resposta_arborizacao.pdf");

      confirmacao.innerText = "✔ Sua resposta foi salva!";
    }
  </script>
